...
public class DatabaseChangelog {
    ...
    @ChangeSet(order = "001", id = "fill", author = "alex.l")
    public void fill(AuthorRepository authorRepository, GenreRepository genreRepository,
        ...
        commentRepository.save(new Comment("1", "Comment1_1", book1));
        commentRepository.save(new Comment("2", "Comment1_2", book1));
        commentRepository.save(new Comment("3", "Comment2_1", book2));
        commentRepository.save(new Comment("4", "Comment2_2", book2));
        commentRepository.save(new Comment("5", "Comment3_1", book3));
        commentRepository.save(new Comment("6", "Comment3_2", book3));
    }
}
